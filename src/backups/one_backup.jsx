...
export default function One() {
    ...
    // check if there is a previous transcript and if there is a focused input field
    if (prevTranscript && document.activeElement && document.activeElement.name) {
        const fieldName = document.activeElement.name;
        setInput(prevInput => ({
            ...prevInput,
            [fieldName]: prevTranscript.trim() // use previous transcript
        }));
    ...
    return (
        <div id="form" className="form-container flex flex-col">
            <input onChange={handleChange} name="firstname" type="text" value={input.firstname} placeholder="First name" className="input-box mx-auto" />
            <input onChange={handleChange} name="lastname" type="text" value={input.lastname} placeholder="Last name" className="input-box mx-auto" />
